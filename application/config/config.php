...
|
*/
$config['base_url'] = 'http://localhost/telar/';
...
$config['protocol'] = 'smtp'; // Specify the email protocol (e.g., smtp, pop3, imap)
$config['smtp_host'] = 'smtp.example.com'; // Set the SMTP server hostname
$config['smtp_user'] = 'your_email@example.com'; // Set the SMTP username
$config['smtp_pass'] = 'your_password'; // Set the SMTP password
$config['smtp_port'] = 587; // Set the SMTP port (usually 587 or 465)
$config['smtp_crypto'] = 'tls'; // Set the SMTP encryption protocol (e.g., tls, ssl)
$config['mailtype'] = 'html'; // Set the email content type (e.g., html, text)
$config['charset'] = 'utf-8'; // Set the email character set
$config['wordwrap'] = TRUE; // Enable word wrapping in emails
$config['newline'] = "\r\n"; // Set the email newline character sequence
