...
<body>
 <h1>Reporte de Proveedor externo </h1>
 ...
 <table>
  ...
  <tr>
   <th colspan="2">
    <h2><?php echo $proveedorexterno[0]->proveedor; ?></h2>
   </th>
...
<tr class="info-section">
    ...
    <tr>
      <td>Dirección:</td>
      <td colspan="3">
        <?php echo 'Calle ' . $proveedorexterno[0]->calle . ' No. Ext. ' . $proveedorexterno[0]->noExterior . ', No. Int. ' . $proveedorexterno[0]->noInterior . ', ' . $proveedorexterno[0]->colonia . ', C.P. ' . $proveedorexterno[0]->cp . ', ' . $proveedorexterno[0]->ciudad . ', ' . $proveedorexterno[0]->estado . ', ' . $proveedorexterno[0]->pais; ?>
      </td>
    </tr>
  ...
  <tr>
   ...
   <td colspan="3"><?php echo $proveedorexterno[0]->correo; ?></td>
  </tr>
  <tr>
   <td>Teléfono 1:</td>
   <td colspan="3"><?php echo $proveedorexterno[0]->telefono1; ?></td>
  </tr>
  <tr>
   <td>Teléfono 2:</td>
   <td colspan="3"><?php echo $proveedorexterno[0]->telefono2; ?></td>
  </tr>
