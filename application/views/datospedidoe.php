 ...
 <!-- <table>  
  ...
  <table>
    ...
    <tr>
      <tr>
        <td>
          <?php echo $proveedorexterno->proveedor; ?><br>
          CALLE <?php echo $proveedorexterno->calle. ' # ' .$proveedorexterno->noExterior ; ?><br>
          COL <?php echo $proveedorexterno->colonia; ?><br>
          CP <?php echo $proveedorexterno->cp; ?> 
          <?php echo $proveedorexterno->ciudad; ?> 
          <?php echo $proveedorexterno->estado; ?> 
          <?php echo $proveedorexterno->pais; ?> <br>
          <?php echo $proveedorexterno->correo; ?>
        </td>
        <td>
